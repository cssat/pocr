...
#'  except the actual totals. Race based totals are kept, for the construction 
...
#'  observing that:
#'  
#'      others count = total count - hispanic count - non_hispanic black 
