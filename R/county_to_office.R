#' Takes a county (string or numeric) and gives the corresponding rows of 
#' ref_lookup_office
#' 
...
county_to_office <- function(county) {
    if (is.numeric(county)) county <- 
            ref_lookup_county$county[ref_lookup_county$county_cd == county]
