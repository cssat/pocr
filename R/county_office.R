...
update_county_data <- function() {
    ...
    save(ref_lookup_county, file = "S:/CA data transfer files/R/Gregor/poc/data/ref_lookup_county.rda")
    ...
    save(ref_lookup_office, file = "S:/CA data transfer files/R/Gregor/poc/data/ref_lookup_office.rda")
}
