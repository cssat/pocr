...
#' @param length_of_stay LOS code, 0: all, 1: > 7 days, 2: > 60 days, 3: > 1 year, 4: > 2 years
#' @param number_of_placements code
#' @param dependency Court Involvement/Dependency code
#' @param year Shouldn't matter to the database, but you can specify if you'd like
#'
#' @export
#' @examples
#' \dontrun{stored_procedure("poc1ab", date = seq(as.Date("2006-01-01"),
#'     as.Date("2009-01-01"), by = "year"), age = 1:3)}
stored_procedure <- function(sp = c("ia_trends_counts", "ia_trends_rates", "ia_safety",
